 ...
 */
public class MockLabelResource
    ...
    private static final long GLOBAL_LABEL_SPACE_MIN = 4097;
    private static final long GLOBAL_LABEL_SPACE_MAX = 5121;
    private static final long LOCAL_LABEL_SPACE_MIN = 5122;
    private static final long LOCAL_LABEL_SPACE_MAX = 9217;
    ...
    private long getLabelId(long min, long max) {
    ...
    public Collection<LabelResource> applyFromDevicePool(DeviceId deviceId,
        ...
        LabelResource label = new DefaultLabelResource(
                deviceId,
                LabelResourceId
                        .labelResourceId(
                                getLabelId(
                                        LOCAL_LABEL_SPACE_MIN,
                                        LOCAL_LABEL_SPACE_MAX)));
        labelList.add(label);
        return labelList;
    }
    ...
    public Collection<LabelResource> applyFromGlobalPool(long applyNum) {
        Collection<LabelResource> labelList = new LinkedList<>();
        LabelResource label = new
                DefaultLabelResource(
                DeviceId.deviceId("foo"),
                LabelResourceId
                        .labelResourceId(getLabelId(GLOBAL_LABEL_SPACE_MIN,
    ...
    @Override
    public boolean releaseToDevicePool(Multimap<DeviceId,
            LabelResource> release) {
        return true;
    }
    ...
    private class InternalDeviceListener implements DeviceListener {
        ...
        public void event(DeviceEvent event) {
            ...
            if (DeviceEvent.Type.DEVICE_REMOVED.equals(event.type())) {
